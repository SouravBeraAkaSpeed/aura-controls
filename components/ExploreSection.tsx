...
const ExploreSection = () => {
    ...
    return (
        <section id="explore" className="relative z-10 w-full px-4 h-full">
            ...
            {/* Foreground content */}
            <div className="relative flex flex-col items-center justify-center gap-12 h-screen z-20">

                <h2 className="text-5xl md:text-6xl font-bold text-center">
                    Explore the Gestures
                </h2>

                <p className="text-center text-lg text-white/70 max-w-2xl">
                    Activate the live demo to control these components directly with your hand.
                    The experience is designed to be seamless, intuitive, and a little bit magical.
                </p>
                ...
                <button
                    ...
                    className={`px-8 py-4 rounded-full font-bold text-xl transition-all duration-300 relative z-30
                        ${isCameraActive
            ...
            {/* Demos */}
            <div className="relative w-full h-full my-8 md:space-y-16 space-y-[180px] z-10">
