...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      type WebGLFormat = { internalFormat: number; format: number } | null;

      const halfFloatTexType: number =
        isWebGL2
          ? (gl as WebGL2RenderingContext).HALF_FLOAT
          : (halfFloat && (halfFloat as { HALF_FLOAT_OES: number }).HALF_FLOAT_OES) || 0;

      let formatRGBA: WebGLFormat;
      let formatRG: WebGLFormat;
      let formatR: WebGLFormat;
    ...
    function initFramebuffers() {
      ...
      if (!rgba || !rg || !r) {
        throw new Error("Required WebGL formats are not supported on this device.");
      }
